...
// Lazy load pages to split the massive bundle and drastically reduce initial load time
...
const SchoolLogin = React.lazy(() => import('./pages/SchoolLogin').then(m => ({ default: m.SchoolLogin })));
const SchoolDashboard = React.lazy(() => import('./pages/SchoolDashboard').then(m => ({ default: m.SchoolDashboard })));
const StudentExamsPage = React.lazy(() => import('./pages/StudentExamsPage'));
const TakeExamPage = React.lazy(() => import('./pages/TakeExamPage'));
const CreateExamPage = React.lazy(() => import('./pages/CreateExamPage'));
const ExamResultsPage = React.lazy(() => import('./pages/ExamResultsPage'));
const AdminDashboard = React.lazy(() => import('./pages/AdminDashboard'));
const GroupWorkPage = React.lazy(() => import('./pages/GroupWorkPage'));
const StoryQuest = React.lazy(() => import('./components/StoryQuest'));
...
const AdminSchoolCreate = React.lazy(() => import('./pages/AdminSchoolCreate'));
const StudentFindAssignment = React.lazy(() => import('./pages/StudentFindAssignment'));
